...
INSERT INTO tb_usuarios (nome, sexo, cpf, telefone, email, login, senha, id_status, id_filial, id_perfil, id_setor, texto_resposta_email, emails_copia, data_cadastro, data_ultima_alteracao_senha) VALUES ('Administrador', 'M', '99999999999', '', 'sgt@euroliftempilhadeiras.com.br', 'admin', SHA1('admin'), 1, 1, 1, 1, 'Conforme vossa solicitação, envio a proposta referente à(s) peça(s) e/ou serviço(s) solicitado(s). Aguardo vossa análise e aprovação.', '', NOW(), NOW());
