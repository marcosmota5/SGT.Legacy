...
Public Class Visualizar_Proposta
    Private Sub Visualizar_Proposta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'MessageBox.Show(get_exibir_codigo)
