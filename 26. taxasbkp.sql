...
data_fim = p_data_fim,
nome = p_nome,
percentual_aliquota_externa_icms_item_nacional = p_percentual_aliquota_externa_icms_item_nacional,
percentual_aliquota_externa_icms_item_importado = p_percentual_aliquota_externa_icms_item_importado,
percentual_mva_item_nacional = p_percentual_mva_item_nacional,
percentual_mva_item_importado = p_percentual_mva_item_importado,
percentual_aliquota_interna_icms_item_nacional = p_percentual_aliquota_interna_icms_item_nacional,
percentual_aliquota_interna_icms_item_importado = p_percentual_aliquota_interna_icms_item_importado,
impostos_federais_item_nacional = p_impostos_federais_item_nacional,
impostos_federais_item_importado = p_impostos_federais_item_importado,
rateio_despesa_fixa_item_nacional = p_rateio_despesa_fixa_item_nacional,
rateio_despesa_fixa_item_importado = p_rateio_despesa_fixa_item_importado,
percentual_lucro_necessario_item_revenda_st_nacional = p_percentual_lucro_necessario_item_revenda_st_nacional,
percentual_lucro_necessario_item_outros_nacional = p_percentual_lucro_necessario_item_outros_nacional,
percentual_lucro_necessario_item_revenda_st_importado = p_percentual_lucro_necessario_item_revenda_st_importado,
percentual_lucro_necessario_item_outros_importado = p_percentual_lucro_necessario_item_outros_importado,
percentual_acrescimo_item_nacional = p_percentual_acrescimo_item_nacional,
percentual_acrescimo_item_importado = p_percentual_acrescimo_item_importado
